...
/*function timer1(){
    ...
    const D = $('.vot-timer-regular .dateNew').text();
    ...
    let x = setInterval(function() {
        ...
        $('.vot-timer-regular .t-days span').text(days);
        $('.vot-timer-regular .t-hours span').text(hours);
        $('.vot-timer-regular .t-minutes span').text(minutes);
        $('.vot-timer-regular .t-seconds span').text(seconds);
...
function timer2(){
    // Set the date we're counting down to
    const D = $('.vot-timer-blk-inner .dateNew').text();
    let countDownDate = new Date(D).getTime();
    ...
    let x = setInterval(function() {
        ...
        // Output the result in an element with id="demo"
        $('.vot-timer-blk-inner .t-days span').text(days);
        $('.vot-timer-blk-inner .t-hours span').text(hours);
        $('.vot-timer-blk-inner .t-minutes span').text(minutes);
        $('.vot-timer-blk-inner .t-seconds span').text(seconds);
